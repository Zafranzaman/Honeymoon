...
struct AppInfoView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            RowAppInfoView(ItemOne: "Developer", ItemTwo: "Zafran / Zaman")
            RowAppInfoView(ItemOne: "Designer", ItemTwo: "Zafran Zaman")
            RowAppInfoView(ItemOne: "Website", ItemTwo: "https://abc.com")
